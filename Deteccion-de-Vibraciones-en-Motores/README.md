# Detección de Vibraciones en Motores

## Descripción

Proyecto de detección, monitoreo y análisis de vibraciones en motores trifásicos mediante sensores inerciales y una aplicación de escritorio desarrollada en C#. El sistema permite adquirir datos en tiempo real y procesarlos para diagnosticar el estado del motor.
...
Desarrollar una plataforma de monitoreo capaz de detectar condiciones anormales de funcionamiento en motores eléctricos mediante el análisis de vibraciones, facilitando la supervisión del equipo y la implementación de mantenimiento predictivo.
