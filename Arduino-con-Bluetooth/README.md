...
Sistema de control para una grúa tipo puerto desarrollado con Arduino y una aplicación móvil creada en MIT App Inventor. El proyecto permite controlar de forma inalámbrica los movimientos de la grúa, incluyendo desplazamiento, posicionamiento y manipulación de objetos mediante una garra accionada por servomotores.
...
Desarrollar un prototipo de grúa tipo puerto controlada de forma inalámbrica desde un dispositivo móvil, integrando sistemas de posicionamiento, actuadores y mecanismos de seguridad para la manipulación remota de objetos.
